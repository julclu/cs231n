...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                ...
                subtract = np.subtract(X[i,:], self.X_train[j,:])

                subtract_sq = subtract**2

                dists[i,j] = np.sqrt(np.sum(subtract_sq))
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            #######################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            subtract_i = np.subtract(X[i,:], self.X_train)
            # print(subtract_i.shape)
            subtract_sq = subtract_i**2
            # print(subtract_sq.shape)
            dists[i,:] = np.sqrt(np.sum(subtract_sq, axis = 1))
            # print(dists[i,:].shape)
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
